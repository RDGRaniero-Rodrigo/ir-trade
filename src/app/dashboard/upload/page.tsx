...
function DashboardUploadContent() {
              ...
              {mercadoSelecionado === "b3" && (
                <div className="mt-5">
                  <div className="mb-2 flex items-center justify-between">
                    <label className="block text-sm font-medium text-white md:text-base">
                      Senha do PDF
                    </label>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      placeholder={
                        senhaSalvaNoBanco
                          ? "Usando senha salva (ou digite uma nova)"
