...
export default function DashboardHomePage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-5 md:px-6 md:py-6">
      ...
      <div className="rounded-[18px] border border-slate-800 bg-[#061538] p-4 md:p-5">
        ...
        {mercadoSelecionado === "b3" && (
          <>
            {!mesSelecionadoB3 ? (
              <div className="rounded-[14px] border border-slate-700 bg-[#081733] p-6 text-center">
                ...
                <Link
                  ...
                  className="mt-4 inline-flex h-9 items-center rounded-lg bg-emerald-500 px-4 text-xs font-semibold text-white transition hover:bg-emerald-600"
                >
                  Importar Nota
                </Link>
              </div>
              ...
              <>
                {/* Resultado Principal */}
                <div className="mb-4 rounded-[14px] border border-slate-700 bg-[#081733] p-4">
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
        <Link
          href="/dashboard/upload"
          className="flex items-center gap-3 rounded-[14px] border border-slate-800 bg-[#061538] p-3.5 transition hover:border-emerald-500/50 hover:bg-[#081733]"
        >
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Upload de PDF ou EML</p>
          </div>
        </Link>
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Ver detalhes e DARF</p>
          </div>
        </Link>
        ...
        <Link
          ...
          className="flex items-center gap-3 rounded-[14px] border border-slate-800 bg-[#061538] p-3.5 transition hover:border-emerald-500/50 hover:bg-[#081733]"
        >
          <div className="rounded-full bg-violet-500/10 p-2.5 text-violet-400">
            <Receipt className="h-4 w-4" />
          </div>
          <div>
            <p className="text-sm font-semibold">Notas Salvas</p>
            <p className="text-xs text-slate-500">Gerenciar histórico</p>
          </div>
        </Link>
      </div>
    </div>
