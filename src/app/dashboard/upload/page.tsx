...
type UploadAba = "importar" | "mensal" | "anual" | "notas";
...
export default function DashboardHomePage() {
  ...
  const [uploadAba, setUploadAba] = useState<UploadAba>("importar");
  ...
  // ─── Helper: abre upload em aba específica ─────────────────────────────────

  function abrirUploadAba(aba: UploadAba) {
    setUploadAba(aba);
    setViewMode("upload");
  }
  ...
  const conteudoB3 = !mesSelecionadoB3 ? (
    <div className="flex min-h-[200px] items-center justify-center rounded-[16px] border border-slate-800 bg-[#061538]">
      <div className="text-center">
        ...
        <button
          onClick={() => abrirUploadAba("importar")}
  ...
  const conteudoPrincipal =
    viewMode === "upload" ? (
      <DashboardUploadPage abaInicial={uploadAba} />
    ) : mercadoSelecionado === "b3" ? (
      conteudoB3
    ) : (
      conteudoForex
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 px-4 py-4 lg:hidden">
        ...
        {/* Botões de Mercado — esconde durante upload */}
        {viewMode === "dashboard" && (
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className={`flex flex-col items-center gap-1.5 rounded-lg border px-2 py-3 text-center text-[10px] text-slate-300 transition ${
                viewMode === "upload" && uploadAba === "importar"
            ...
            <button
              onClick={() => abrirUploadAba("mensal")}
              className={`flex flex-col items-center gap-1.5 rounded-lg border px-2 py-3 text-center text-[10px] text-slate-300 transition ${
                viewMode === "upload" && uploadAba === "mensal"
                  ? "border-emerald-500/50 bg-emerald-500/10"
                  : "border-slate-800 bg-[#061538] hover:border-emerald-500/50"
              }`}
            >
            ...
            <button
              onClick={() => abrirUploadAba("notas")}
              className={`flex flex-col items-center gap-1.5 rounded-lg border px-2 py-3 text-center text-[10px] text-slate-300 transition ${
                viewMode === "upload" && uploadAba === "notas"
                  ? "border-emerald-500/50 bg-emerald-500/10"
                  : "border-slate-800 bg-[#061538] hover:border-emerald-500/50"
              }`}
            >
        ...
        <div className="flex w-48 flex-shrink-0 flex-col gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              ...
              <span className={viewMode === "upload" && uploadAba === "importar" ? "text-emerald-400" : "text-slate-300"}>
                Importar Nota
              </span>
            </button>
            ...
            >
              ...
              <span className={viewMode === "upload" && uploadAba === "mensal" ? "text-emerald-400" : "text-slate-300"}>
                Resumo Mensal
              </span>
            </button>
            ...
            >
              ...
              <span className={viewMode === "upload" && uploadAba === "notas" ? "text-emerald-400" : "text-slate-300"}>
                Notas Salvas
              </span>
            </button>
          </div>
